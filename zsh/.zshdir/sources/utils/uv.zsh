...
'(--dev --optional --package)--script=[Add the dependency to the specified Python script, rather than to a project]:SCRIPT:_files' \
...
(version)
_arguments "${_arguments_options[@]}" : \
'--bump=[Update the project version using the given semantics]:BUMP:((major\:"Increase the major version (1.2.3 => 2.0.0)"
